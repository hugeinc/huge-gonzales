...
module.exports = (function() {
    ...
    var rules = {
        ...
        'pythonINC': function() { return checkPythonINC(pos) && checkPythonINC(); },
...
/////////////////////////////////////
    ...
    */
    ...
    function checkPythonINC(i) {
        return i < tokensLength && tokens[i].type === TokenType.PythonINC ? 1 : 0;
    }
    ...
    function getPythonINC() {
        var startPos = pos,
            x;

        x = [NodeType.PythonINCType, tokens[pos++].value.substring(2)];
    ...
    function getSC() {
        ...
        while (pos < tokensLength) {
            ...
            else if (checkPythonINC(pos)) sc.push(getPythonINC());
